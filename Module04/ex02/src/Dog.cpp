...
/*   Updated: 2025/07/18 12:21:42 by umeneses         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Dog.hpp"

Dog::Dog(void) : AAnimal(), _className("Dog")
{
	_myBrain = new Brain();
	_printer.constructorTitlePrinter(_className, "Weird Dog");
}

Dog::Dog(std::string type) : AAnimal(type), _className("Dog")
{
	_myBrain = new Brain();
...
Dog::Dog(Dog const &src) : AAnimal(src._type), _className(src._className)
{
